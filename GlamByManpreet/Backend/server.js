...
import supabase from '../src/config/supabaseClient.js'; // Import your Supabase client
...
router.get('/users', async (req, res) => {
  try {
    // Fetch all users from the 'users' table using Supabase
    ...
    res.status(200).json(data); // Send the users as JSON response
  } catch (err) {
